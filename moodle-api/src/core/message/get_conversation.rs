...
pub struct Params {
    ...
    pub r#includecontactrequests: Option<bool>,
    /// Include privacy info in the members
    #[serde(rename = "includeprivacyinfo")]
    pub r#includeprivacyinfo: Option<bool>,
    /// Limit for number of members
    #[serde(rename = "memberlimit")]
    pub r#memberlimit: Option<i64>,
    /// Offset for member list
    #[serde(rename = "memberoffset")]
    pub r#memberoffset: Option<i64>,
...
pub async fn call<'a>(
    ...
    let json = client.post("core_message_get_conversation", params).await?;
...
pub async fn call_raw<'a>(
    ...
    client.post("core_message_get_conversation", params).await
}
