...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsItemUsercompetencyReviewer {
    /// id
    #[serde(rename = "id")]
    pub r#id: Option<i64>,
    /// email
...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsItemUsercompetency {
    /// userid
    #[serde(rename = "userid")]
    ...
    pub r#reviewer: Option<ReturnsItemUsercompetencyReviewer>,
    /// statusname
...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsItemUsercompetencyplan {
    /// userid
    #[serde(rename = "userid")]
    pub r#userid: Option<i64>,
    /// competencyid
...
pub struct ReturnsItem {
    ...
    pub r#competency: Option<ReturnsItemCompetency>,
    #[serde(rename = "usercompetency")]
    pub r#usercompetency: Option<ReturnsItemUsercompetency>,
    #[serde(rename = "usercompetencyplan")]
    pub r#usercompetencyplan: Option<ReturnsItemUsercompetencyplan>,
}
...
pub async fn call<'a>(
    ...
    let json = client
        .post("core_competency_list_plan_competencies", params)
        .await?;
