...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsGroupedbycourseItemEventsItemIcon {
    /// key
    #[serde(rename = "key")]
...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsGroupedbycourseItemEventsItemCategory {
    /// id
    #[serde(rename = "id")]
    pub r#id: Option<i64>,
    /// name
...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsGroupedbycourseItemEventsItemCourse {
    /// id
    #[serde(rename = "id")]
    pub r#id: Option<i64>,
    /// fullname
...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsGroupedbycourseItemEventsItemSubscription {
    /// displayeventsource
...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsGroupedbycourseItemEventsItemAction {
    /// name
    #[serde(rename = "name")]
    pub r#name: Option<String>,
    /// url
...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsGroupedbycourseItemEventsItem {
    /// id
    #[serde(rename = "id")]
    pub r#id: Option<i64>,
    /// name
    ...
    #[serde(rename = "icon")]
    pub r#icon: Option<ReturnsGroupedbycourseItemEventsItemIcon>,
    #[serde(rename = "category")]
    pub r#category: Option<ReturnsGroupedbycourseItemEventsItemCategory>,
    #[serde(rename = "course")]
    pub r#course: Option<ReturnsGroupedbycourseItemEventsItemCourse>,
    #[serde(rename = "subscription")]
    pub r#subscription: Option<ReturnsGroupedbycourseItemEventsItemSubscription>,
    /// canedit
    ...
    #[serde(rename = "action")]
    pub r#action: Option<ReturnsGroupedbycourseItemEventsItemAction>,
    /// purpose
...
/// events
pub type r#ReturnsGroupedbycourseItemEvents = Vec<ReturnsGroupedbycourseItemEventsItem>;

#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsGroupedbycourseItem {
    /// events
    #[serde(rename = "events")]
    pub r#events: Option<r#ReturnsGroupedbycourseItemEvents>,
    /// firstid
...
/// groupedbycourse
pub type r#ReturnsGroupedbycourse = Vec<ReturnsGroupedbycourseItem>;

#[derive(Serialize, Deserialize, Debug)]
pub struct Returns {
    /// groupedbycourse
    #[serde(rename = "groupedbycourse")]
    pub r#groupedbycourse: Option<r#ReturnsGroupedbycourse>,
}
...
pub async fn call<'a>(
    ...
    let json = client
        .post("core_calendar_get_action_events_by_courses", params)
        .await?;
