...
pub struct Returns {
    ...
    pub r#completed: Option<ReturnsCompleted>,
    /// list of warnings
...
pub async fn call<'a>(
    ...
    let json = client
        .post("mod_feedback_get_last_completed", params)
        .await?;
...
pub async fn call_raw<'a>(
    ...
    client.post("mod_feedback_get_last_completed", params).await
}
