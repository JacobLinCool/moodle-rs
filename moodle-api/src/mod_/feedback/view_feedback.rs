...
pub struct Params {
    ...
    #[serde(rename = "moduleviewed")]
    pub r#moduleviewed: Option<bool>,
...
pub async fn call<'a>(
    ...
    let json = client.post("mod_feedback_view_feedback", params).await?;
...
pub async fn call_raw<'a>(
    ...
    client.post("mod_feedback_view_feedback", params).await
}
