...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsAssessmentFeedbackcontentfilesItem {
    /// File name.
...
pub type r#ReturnsAssessmentFeedbackcontentfiles = Vec<ReturnsAssessmentFeedbackcontentfilesItem>;

#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsAssessmentFeedbackattachmentfilesItem {
    /// File name.
    #[serde(rename = "filename")]
    pub r#filename: Option<String>,
    /// File path.
...
pub type r#ReturnsAssessmentFeedbackattachmentfiles =
    Vec<ReturnsAssessmentFeedbackattachmentfilesItem>;

#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsAssessment {
    ...
    pub r#feedbackcontentfiles: Option<r#ReturnsAssessmentFeedbackcontentfiles>,
    /// feedbackattachmentfiles
    #[serde(rename = "feedbackattachmentfiles")]
    pub r#feedbackattachmentfiles: Option<r#ReturnsAssessmentFeedbackattachmentfiles>,
}
...
pub struct Returns {
    ...
    pub r#assessment: Option<ReturnsAssessment>,
    /// list of warnings
...
pub async fn call<'a>(
    ...
    let json = client.post("mod_workshop_get_assessment", params).await?;
...
pub async fn call_raw<'a>(
    ...
    client.post("mod_workshop_get_assessment", params).await
}
