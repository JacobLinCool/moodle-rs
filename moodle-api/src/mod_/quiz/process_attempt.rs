...
pub struct Params {
    ...
    #[serde(rename = "finishattempt")]
    pub r#finishattempt: Option<bool>,
    /// whether the WS was called by a timer when the time is up
    #[serde(rename = "timeup")]
    pub r#timeup: Option<bool>,
    /// Preflight required data (like passwords)
...
pub async fn call<'a>(
    ...
    let json = client.post("mod_quiz_process_attempt", params).await?;
...
pub async fn call_raw<'a>(
    ...
    client.post("mod_quiz_process_attempt", params).await
}
