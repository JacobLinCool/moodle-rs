...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsLessonIntrofilesItem {
    /// File name.
...
/// introfiles
pub type r#ReturnsLessonIntrofiles = Vec<ReturnsLessonIntrofilesItem>;

#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsLessonMediafilesItem {
    /// File name.
    #[serde(rename = "filename")]
    pub r#filename: Option<String>,
    /// File path.
...
/// mediafiles
pub type r#ReturnsLessonMediafiles = Vec<ReturnsLessonMediafilesItem>;

#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsLesson {
    ...
    pub r#introfiles: Option<r#ReturnsLessonIntrofiles>,
    /// mediafiles
    #[serde(rename = "mediafiles")]
    pub r#mediafiles: Option<r#ReturnsLessonMediafiles>,
}
...
pub struct Returns {
    #[serde(rename = "lesson")]
    pub r#lesson: Option<ReturnsLesson>,
    /// list of warnings
...
pub async fn call<'a>(
    ...
    let json = client.post("mod_lesson_get_lesson", params).await?;
...
pub async fn call_raw<'a>(
    ...
    client.post("mod_lesson_get_lesson", params).await
}
