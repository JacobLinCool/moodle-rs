...
pub async fn call<'a>(
    ...
    let json = client.post("tool_lp_data_for_plans_page", params).await?;
...
pub async fn call_raw<'a>(
    ...
    client.post("tool_lp_data_for_plans_page", params).await
}
