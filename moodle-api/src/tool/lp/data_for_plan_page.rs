...
pub struct ReturnsCompetenciesItemUsercompetency {
    ...
    #[serde(rename = "reviewer")]
    pub r#reviewer: Option<ReturnsCompetenciesItemUsercompetencyReviewer>,
    /// statusname
    #[serde(rename = "statusname")]
    pub r#statusname: Option<String>,
    /// url
...
pub struct ReturnsCompetenciesItem {
    ...
    pub r#usercompetency: Option<ReturnsCompetenciesItemUsercompetency>,
    #[serde(rename = "usercompetencyplan")]
    pub r#usercompetencyplan: Option<ReturnsCompetenciesItemUsercompetencyplan>,
}
...
pub async fn call_raw<'a>(
    ...
    client.post("tool_lp_data_for_plan_page", params).await
}
