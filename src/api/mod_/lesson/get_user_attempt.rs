...
pub type r#ReturnsAnswerpagesItemAnswerdataAnswersItem = Vec<Option<String>>;

/// User answers
pub type r#ReturnsAnswerpagesItemAnswerdataAnswers =
    Vec<ReturnsAnswerpagesItemAnswerdataAnswersItem>;
...
pub struct ReturnsAnswerpagesItemAnswerdata {
    ...
    pub r#answers: ReturnsAnswerpagesItemAnswerdataAnswers,
}
...
pub struct ReturnsAnswerpagesItem {
    /// Page fields
    #[serde(rename = "page")]
    pub r#page: ReturnsAnswerpagesItemPage,
    /// Page title.
    #[serde(rename = "title")]
    pub r#title: Option<String>,
    /// Page contents.
    ...
    pub r#answerdata: ReturnsAnswerpagesItemAnswerdata,
}
...
pub struct ReturnsUserstats {
    ...
    pub r#gradeinfo: ReturnsUserstatsGradeinfo,
}
...
pub struct Returns {
    ...
    pub r#answerpages: ReturnsAnswerpages,
    #[serde(rename = "userstats")]
    pub r#userstats: ReturnsUserstats,
    /// list of warnings
