...
pub type r#ReturnsPagesItemAnswerids = Vec<Option<i64>>;

/// List of possible page jumps
pub type r#ReturnsPagesItemJumps = Vec<Option<i64>>;
...
pub struct ReturnsPagesItem {
    /// Page fields
    #[serde(rename = "page")]
    pub r#page: ReturnsPagesItemPage,
    /// List of answers ids (empty for content pages in  Moodle 1.9)
    #[serde(rename = "answerids")]
    pub r#answerids: ReturnsPagesItemAnswerids,
    /// List of possible page jumps
    #[serde(rename = "jumps")]
    pub r#jumps: ReturnsPagesItemJumps,
