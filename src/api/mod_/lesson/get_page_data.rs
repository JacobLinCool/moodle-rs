...
pub struct ReturnsAnswersItem {
    ...
    pub r#answerfiles: ReturnsAnswersItemAnswerfiles,
    /// List of files.
    #[serde(rename = "responsefiles")]
    pub r#responsefiles: ReturnsAnswersItemResponsefiles,
...
pub struct Returns {
    ...
    pub r#contentfiles: ReturnsContentfiles,
    #[serde(rename = "answers")]
    pub r#answers: ReturnsAnswers,
