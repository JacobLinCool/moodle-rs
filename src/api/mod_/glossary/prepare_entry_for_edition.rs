...
pub struct ReturnsAreasItem {
    ...
    pub r#options: ReturnsAreasItemOptions,
}

/// File areas including options
pub type r#ReturnsAreas = Vec<ReturnsAreasItem>;

pub type r#ReturnsAliases = Vec<Option<String>>;

pub type r#ReturnsCategories = Vec<Option<i64>>;
...
pub struct Returns {
    ...
    pub r#aliases: ReturnsAliases,
    #[serde(rename = "categories")]
    pub r#categories: ReturnsCategories,
    /// list of warnings
