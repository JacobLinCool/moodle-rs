...
pub struct Params {
    ...
    /// The query
    #[serde(rename = "fullsearch")]
    pub r#fullsearch: Option<bool>,
...
pub struct ReturnsEntriesItem {
    ...
    pub r#definitioninlinefiles: ReturnsEntriesItemDefinitioninlinefiles,
    /// Whether or not the entry has attachments
    #[serde(rename = "attachment")]
    pub r#attachment: Option<bool>,
    /// attachments
    #[serde(rename = "attachments")]
    pub r#attachments: ReturnsEntriesItemAttachments,
    /// Time created
...
pub async fn call<'a>(
    ...
    let json = client
        .post("mod_glossary_get_entries_by_search", params)
        .await?;
