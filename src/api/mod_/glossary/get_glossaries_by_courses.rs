...
pub type r#ReturnsGlossariesItemBrowsemodes = Vec<Option<String>>;
...
pub struct ReturnsGlossariesItem {
    ...
    pub r#introfiles: ReturnsGlossariesItemIntrofiles,
    /// Course section id
    ...
    pub r#browsemodes: ReturnsGlossariesItemBrowsemodes,
...
pub struct Returns {
    ...
    pub r#glossaries: ReturnsGlossaries,
    /// list of warnings
