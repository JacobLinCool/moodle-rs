...
pub struct ReturnsDiscussionsItem {
    ...
    pub r#messageinlinefiles: ReturnsDiscussionsItemMessageinlinefiles,
    /// Has attachments?
    #[serde(rename = "attachment")]
    pub r#attachment: Option<String>,
    /// attachments
    #[serde(rename = "attachments")]
    pub r#attachments: ReturnsDiscussionsItemAttachments,
...
pub async fn call<'a>(
    ...
    let json = client
        .post("mod_forum_get_forum_discussions_paginated", params)
        .await?;
