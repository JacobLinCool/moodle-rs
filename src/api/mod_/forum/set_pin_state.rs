...
pub struct Returns {
    ...
    #[serde(rename = "group")]
    pub r#group: ReturnsGroup,
    #[serde(rename = "times")]
    pub r#times: ReturnsTimes,
    #[serde(rename = "userstate")]
    pub r#userstate: ReturnsUserstate,
    #[serde(rename = "capabilities")]
    pub r#capabilities: ReturnsCapabilities,
    #[serde(rename = "urls")]
    pub r#urls: ReturnsUrls,
    #[serde(rename = "timed")]
    pub r#timed: ReturnsTimed,
}
...
pub async fn call<'a>(
    ...
    let json = client.post("mod_forum_set_pin_state", params).await?;
