...
pub struct ReturnsPostsItemAuthorGroupsItem {
    ...
    #[serde(rename = "urls")]
    pub r#urls: ReturnsPostsItemAuthorGroupsItemUrls,
}
...
pub struct ReturnsPostsItemAuthor {
    ...
    /// groups
    #[serde(rename = "groups")]
    pub r#groups: ReturnsPostsItemAuthorGroups,
    #[serde(rename = "urls")]
    pub r#urls: ReturnsPostsItemAuthorUrls,
}
...
pub struct ReturnsPostsItemAttachmentsItem {
    ...
    #[serde(rename = "urls")]
    pub r#urls: ReturnsPostsItemAttachmentsItemUrls,
    #[serde(rename = "html")]
    pub r#html: ReturnsPostsItemAttachmentsItemHtml,
}
...
pub struct ReturnsPostsItemTagsItem {
    ...
    #[serde(rename = "urls")]
    pub r#urls: ReturnsPostsItemTagsItemUrls,
}
...
pub struct ReturnsPostsItem {
    ...
    #[serde(rename = "author")]
    pub r#author: ReturnsPostsItemAuthor,
    /// discussionid
    #[serde(rename = "discussionid")]
    pub r#discussionid: Option<i64>,
    /// hasparent
    ...
    pub r#capabilities: ReturnsPostsItemCapabilities,
    #[serde(rename = "urls")]
    pub r#urls: ReturnsPostsItemUrls,
    /// attachments
    #[serde(rename = "attachments")]
    pub r#attachments: ReturnsPostsItemAttachments,
    /// messageinlinefiles
    #[serde(rename = "messageinlinefiles")]
    pub r#messageinlinefiles: ReturnsPostsItemMessageinlinefiles,
    /// tags
    #[serde(rename = "tags")]
    pub r#tags: ReturnsPostsItemTags,
    #[serde(rename = "html")]
    pub r#html: ReturnsPostsItemHtml,
}
