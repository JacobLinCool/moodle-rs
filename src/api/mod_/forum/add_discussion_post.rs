...
pub struct ReturnsPostAuthorGroupsItem {
    ...
    pub r#name: Option<String>,
    #[serde(rename = "urls")]
    pub r#urls: ReturnsPostAuthorGroupsItemUrls,
}
...
pub struct ReturnsPostAuthor {
    ...
    /// groups
    #[serde(rename = "groups")]
    pub r#groups: ReturnsPostAuthorGroups,
    #[serde(rename = "urls")]
    pub r#urls: ReturnsPostAuthorUrls,
}
...
pub struct ReturnsPostAttachmentsItem {
    ...
    #[serde(rename = "urls")]
    pub r#urls: ReturnsPostAttachmentsItemUrls,
    #[serde(rename = "html")]
    pub r#html: ReturnsPostAttachmentsItemHtml,
}
...
pub struct ReturnsPostTagsItem {
    ...
    #[serde(rename = "urls")]
    pub r#urls: ReturnsPostTagsItemUrls,
}
...
pub struct ReturnsPost {
    ...
    pub r#messageformat: Option<i64>,
    #[serde(rename = "author")]
    pub r#author: ReturnsPostAuthor,
    /// discussionid
    ...
    pub r#capabilities: ReturnsPostCapabilities,
    #[serde(rename = "urls")]
    pub r#urls: ReturnsPostUrls,
    /// attachments
    #[serde(rename = "attachments")]
    pub r#attachments: ReturnsPostAttachments,
    /// messageinlinefiles
    #[serde(rename = "messageinlinefiles")]
    pub r#messageinlinefiles: ReturnsPostMessageinlinefiles,
    /// tags
    #[serde(rename = "tags")]
    pub r#tags: ReturnsPostTags,
    #[serde(rename = "html")]
    pub r#html: ReturnsPostHtml,
}
...
pub async fn call<'a>(
    ...
    let json = client.post("mod_forum_add_discussion_post", params).await?;
