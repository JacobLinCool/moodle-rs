...
pub struct ParamsAdvsearchItem {
...
/// Advanced search
pub type r#ParamsAdvsearch = Vec<ParamsAdvsearchItem>;
...
pub struct Params {
    ...
    pub r#advsearch: ParamsAdvsearch,
...
pub struct ReturnsEntriesItemContentsItem {
    ...
    /// files
    #[serde(rename = "files")]
    pub r#files: ReturnsEntriesItemContentsItemFiles,
}
...
pub struct ReturnsEntriesItem {
    ...
    pub r#contents: ReturnsEntriesItemContents,
    /// Tags.
    #[serde(rename = "tags")]
    pub r#tags: ReturnsEntriesItemTags,
}
...
pub async fn call<'a>(
    ...
    let json = client.post("mod_data_search_entries", params).await?;
