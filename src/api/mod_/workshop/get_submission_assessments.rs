...
pub struct ReturnsAssessmentsItem {
    ...
    pub r#feedbackcontentfiles: ReturnsAssessmentsItemFeedbackcontentfiles,
    /// feedbackattachmentfiles
    #[serde(rename = "feedbackattachmentfiles")]
    pub r#feedbackattachmentfiles: ReturnsAssessmentsItemFeedbackattachmentfiles,
}
...
pub struct Returns {
    ...
    pub r#assessments: ReturnsAssessments,
    /// list of warnings
...
pub async fn call<'a>(
    ...
    let json = client
        .post("mod_workshop_get_submission_assessments", params)
        .await?;
