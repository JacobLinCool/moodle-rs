...
pub struct ReturnsAssessment {
    ...
    pub r#feedbackcontentfiles: ReturnsAssessmentFeedbackcontentfiles,
    /// feedbackattachmentfiles
    #[serde(rename = "feedbackattachmentfiles")]
    pub r#feedbackattachmentfiles: ReturnsAssessmentFeedbackattachmentfiles,
}
...
pub struct Returns {
    ...
    pub r#assessment: ReturnsAssessment,
    /// list of warnings
