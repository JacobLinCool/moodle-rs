...
pub struct ReturnsUserplanPhasesItem {
    ...
    #[serde(rename = "tasks")]
    pub r#tasks: ReturnsUserplanPhasesItemTasks,
    #[serde(rename = "actions")]
    pub r#actions: ReturnsUserplanPhasesItemActions,
}
...
pub struct ReturnsUserplan {
    #[serde(rename = "phases")]
    pub r#phases: ReturnsUserplanPhases,
    #[serde(rename = "examples")]
    pub r#examples: ReturnsUserplanExamples,
}
...
pub struct Returns {
    ...
    pub r#userplan: ReturnsUserplan,
    /// list of warnings
