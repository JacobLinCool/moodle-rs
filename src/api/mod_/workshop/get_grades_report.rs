...
pub struct ReturnsReportGradesItem {
    ...
    pub r#reviewedby: ReturnsReportGradesItemReviewedby,
    /// The assessments the user reviewed.
    #[serde(rename = "reviewerof")]
    pub r#reviewerof: ReturnsReportGradesItemReviewerof,
}
...
pub struct ReturnsReport {
    #[serde(rename = "grades")]
    pub r#grades: ReturnsReportGrades,
