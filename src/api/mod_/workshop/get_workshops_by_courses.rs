...
pub struct ReturnsWorkshopsItem {
    ...
    pub r#introfiles: ReturnsWorkshopsItemIntrofiles,
    /// instructauthorsfiles
    #[serde(rename = "instructauthorsfiles")]
    pub r#instructauthorsfiles: ReturnsWorkshopsItemInstructauthorsfiles,
    /// instructreviewersfiles
    #[serde(rename = "instructreviewersfiles")]
    pub r#instructreviewersfiles: ReturnsWorkshopsItemInstructreviewersfiles,
    /// conclusionfiles
    #[serde(rename = "conclusionfiles")]
    pub r#conclusionfiles: ReturnsWorkshopsItemConclusionfiles,
}
...
pub struct Returns {
    ...
    pub r#workshops: ReturnsWorkshops,
    /// list of warnings
