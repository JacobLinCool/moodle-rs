...
/// Attempt ids
pub type r#ParamsAttemptids = Vec<Option<i64>>;
...
pub struct Params {
    ...
    pub r#attemptids: ParamsAttemptids,
}
...
pub struct ReturnsAttemptsItemResultsItemOptionsItem {
    ...
    pub r#correctanswer: ReturnsAttemptsItemResultsItemOptionsItemCorrectanswer,
    /// The option user answer
    #[serde(rename = "useranswer")]
    pub r#useranswer: ReturnsAttemptsItemResultsItemOptionsItemUseranswer,
}
...
pub struct ReturnsAttemptsItemResultsItem {
    ...
    pub r#options: ReturnsAttemptsItemResultsItemOptions,
}
...
pub struct ReturnsAttemptsItem {
    ...
    pub r#results: ReturnsAttemptsItemResults,
}
...
pub struct Returns {
    ...
    pub r#attempts: ReturnsAttempts,
    /// list of warnings
