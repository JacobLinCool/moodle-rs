...
pub struct ReturnsUsersattemptsItemScored {
    ...
    pub r#attempts: ReturnsUsersattemptsItemScoredAttempts,
}
...
pub struct ReturnsUsersattemptsItem {
    ...
    /// The complete attempts list
    #[serde(rename = "attempts")]
    pub r#attempts: ReturnsUsersattemptsItemAttempts,
    /// Attempts used to grade the activity
    #[serde(rename = "scored")]
    pub r#scored: ReturnsUsersattemptsItemScored,
}
...
pub struct Returns {
    ...
    pub r#usersattempts: ReturnsUsersattempts,
    /// list of warnings
...
pub async fn call<'a>(
    ...
    let json = client.post("mod_h5pactivity_get_attempts", params).await?;
