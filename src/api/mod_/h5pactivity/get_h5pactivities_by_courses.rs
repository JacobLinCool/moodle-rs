...
pub struct ReturnsH5pactivitiesItem {
    ...
    pub r#introfiles: ReturnsH5pactivitiesItemIntrofiles,
    /// package
    #[serde(rename = "package")]
    pub r#package: ReturnsH5pactivitiesItemPackage,
    #[serde(rename = "deployedfile")]
    pub r#deployedfile: ReturnsH5pactivitiesItemDeployedfile,
}
...
pub struct Returns {
    ...
    pub r#h5pactivities: ReturnsH5pactivities,
    /// H5P global settings
    #[serde(rename = "h5pglobalsettings")]
    pub r#h5pglobalsettings: ReturnsH5pglobalsettings,
    /// list of warnings
