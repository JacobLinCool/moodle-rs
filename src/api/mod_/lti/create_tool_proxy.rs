...
pub type r#ParamsCapabilityoffered = Vec<Option<String>>;

/// Array of services
pub type r#ParamsServiceoffered = Vec<Option<String>>;
...
pub struct Params {
    ...
    pub r#capabilityoffered: ParamsCapabilityoffered,
    /// Array of services
    #[serde(rename = "serviceoffered")]
    pub r#serviceoffered: ParamsServiceoffered,
}
