...
pub struct Params {
    ...
    #[serde(rename = "cartridgeurl")]
    pub r#cartridgeurl: Option<String>,
    /// Consumer key
    #[serde(rename = "key")]
...
pub type r#ReturnsCapabilitygroups = Vec<Option<String>>;

/// IDs for the LTI instances using this type
pub type r#ReturnsInstanceids = Vec<Option<i64>>;
...
pub struct Returns {
    ...
    #[serde(rename = "urls")]
    pub r#urls: ReturnsUrls,
    #[serde(rename = "state")]
    pub r#state: ReturnsState,
    ...
    pub r#capabilitygroups: ReturnsCapabilitygroups,
    /// Tool type course
    #[serde(rename = "courseid")]
    pub r#courseid: Option<i64>,
    /// IDs for the LTI instances using this type
    #[serde(rename = "instanceids")]
    pub r#instanceids: ReturnsInstanceids,
...
pub async fn call<'a>(
    ...
    let json = client.post("mod_lti_create_tool_type", params).await?;
