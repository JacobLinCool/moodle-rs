...
pub type r#ReturnsTypesItemCapabilitygroups = Vec<Option<String>>;

/// IDs for the LTI instances using this type
pub type r#ReturnsTypesItemInstanceids = Vec<Option<i64>>;
...
pub struct ReturnsTypesItem {
    ...
    #[serde(rename = "urls")]
    pub r#urls: ReturnsTypesItemUrls,
    #[serde(rename = "state")]
    pub r#state: ReturnsTypesItemState,
    ...
    pub r#capabilitygroups: ReturnsTypesItemCapabilitygroups,
    /// Tool type course
    #[serde(rename = "courseid")]
    pub r#courseid: Option<i64>,
    /// IDs for the LTI instances using this type
    #[serde(rename = "instanceids")]
    pub r#instanceids: ReturnsTypesItemInstanceids,
...
pub struct Returns {
    #[serde(rename = "types")]
    pub r#types: ReturnsTypes,
    #[serde(rename = "proxies")]
    pub r#proxies: ReturnsProxies,
