...
pub type r#ReturnsItemCapabilitygroups = Vec<Option<String>>;

/// IDs for the LTI instances using this type
pub type r#ReturnsItemInstanceids = Vec<Option<i64>>;
...
pub struct ReturnsItem {
    ...
    #[serde(rename = "urls")]
    pub r#urls: ReturnsItemUrls,
    #[serde(rename = "state")]
    pub r#state: ReturnsItemState,
    ...
    pub r#capabilitygroups: ReturnsItemCapabilitygroups,
    /// Tool type course
    #[serde(rename = "courseid")]
    pub r#courseid: Option<i64>,
    /// IDs for the LTI instances using this type
    #[serde(rename = "instanceids")]
    pub r#instanceids: ReturnsItemInstanceids,
