...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsAdditionaldataItem {
    /// id of the data
    #[serde(rename = "id")]
...
pub type r#ReturnsAdditionaldata = Vec<ReturnsAdditionaldataItem>;
...
pub struct ReturnsQuestionsItemResponsefileareasItem {
    ...
    /// Response files for the question
    #[serde(rename = "files")]
    pub r#files: ReturnsQuestionsItemResponsefileareasItemFiles,
}
...
pub struct ReturnsQuestionsItem {
    ...
    pub r#responsefileareas: ReturnsQuestionsItemResponsefileareas,
...
pub struct Returns {
    ...
    #[serde(rename = "attempt")]
    pub r#attempt: ReturnsAttempt,
    #[serde(rename = "additionaldata")]
    pub r#additionaldata: ReturnsAdditionaldata,
    #[serde(rename = "questions")]
    pub r#questions: ReturnsQuestions,
    /// list of warnings
