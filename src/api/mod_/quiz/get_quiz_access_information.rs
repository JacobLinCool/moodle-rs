...
/// list of rules
pub type r#ReturnsAccessrules = Vec<Option<String>>;

/// list of active rules
pub type r#ReturnsActiverulenames = Vec<Option<String>>;

/// list of reasons
pub type r#ReturnsPreventaccessreasons = Vec<Option<String>>;
...
pub struct Returns {
    ...
    pub r#accessrules: ReturnsAccessrules,
    /// list of active rules
    #[serde(rename = "activerulenames")]
    pub r#activerulenames: ReturnsActiverulenames,
    /// list of reasons
    #[serde(rename = "preventaccessreasons")]
    pub r#preventaccessreasons: ReturnsPreventaccessreasons,
    /// list of warnings
