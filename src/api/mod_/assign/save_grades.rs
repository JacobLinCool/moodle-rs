...
pub struct ParamsGradesItemPlugindata {
    ...
    pub r#assignfeedbackcomments_editor: ParamsGradesItemPlugindataAssignfeedbackcommentsEditor,
...
pub struct ParamsGradesItemAdvancedgradingdataGuideCriteriaItem {
    ...
    pub r#fillings: ParamsGradesItemAdvancedgradingdataGuideCriteriaItemFillings,
}
...
pub struct ParamsGradesItemAdvancedgradingdataGuide {
    ...
    pub r#criteria: ParamsGradesItemAdvancedgradingdataGuideCriteria,
}
...
pub struct ParamsGradesItemAdvancedgradingdataRubricCriteriaItem {
    ...
    /// filling
    #[serde(rename = "fillings")]
    pub r#fillings: ParamsGradesItemAdvancedgradingdataRubricCriteriaItemFillings,
}
...
pub struct ParamsGradesItemAdvancedgradingdataRubric {
    #[serde(rename = "criteria")]
    pub r#criteria: ParamsGradesItemAdvancedgradingdataRubricCriteria,
}
...
pub struct ParamsGradesItemAdvancedgradingdata {
    /// items
    #[serde(rename = "guide")]
    pub r#guide: ParamsGradesItemAdvancedgradingdataGuide,
    /// items
    #[serde(rename = "rubric")]
    pub r#rubric: ParamsGradesItemAdvancedgradingdataRubric,
}
...
pub struct ParamsGradesItem {
    ...
    pub r#plugindata: ParamsGradesItemPlugindata,
    /// advanced grading data
    #[serde(rename = "advancedgradingdata")]
    pub r#advancedgradingdata: ParamsGradesItemAdvancedgradingdata,
}
