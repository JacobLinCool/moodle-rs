...
pub struct ReturnsLastattemptSubmissionPluginsItemFileareasItem {
    ...
    /// files
    #[serde(rename = "files")]
    pub r#files: ReturnsLastattemptSubmissionPluginsItemFileareasItemFiles,
}
...
pub struct ReturnsLastattemptSubmissionPluginsItem {
    ...
    pub r#fileareas: ReturnsLastattemptSubmissionPluginsItemFileareas,
    /// editorfields
    #[serde(rename = "editorfields")]
    pub r#editorfields: ReturnsLastattemptSubmissionPluginsItemEditorfields,
}
...
pub struct ReturnsLastattemptSubmission {
    ...
    pub r#plugins: ReturnsLastattemptSubmissionPlugins,
    /// Grading status.
...
pub struct ReturnsLastattemptTeamsubmissionPluginsItemFileareasItem {
    ...
    /// files
    #[serde(rename = "files")]
    pub r#files: ReturnsLastattemptTeamsubmissionPluginsItemFileareasItemFiles,
}
...
pub struct ReturnsLastattemptTeamsubmissionPluginsItem {
    ...
    /// fileareas
    #[serde(rename = "fileareas")]
    pub r#fileareas: ReturnsLastattemptTeamsubmissionPluginsItemFileareas,
    /// editorfields
    #[serde(rename = "editorfields")]
    pub r#editorfields: ReturnsLastattemptTeamsubmissionPluginsItemEditorfields,
}
...
pub struct ReturnsLastattemptTeamsubmission {
    ...
    /// plugins
    #[serde(rename = "plugins")]
    pub r#plugins: ReturnsLastattemptTeamsubmissionPlugins,
    /// Grading status.
    #[serde(rename = "gradingstatus")]
    pub r#gradingstatus: Option<String>,
}
...
pub type r#ReturnsLastattemptSubmissiongroupmemberswhoneedtosubmit = Vec<Option<i64>>;

/// User groups in the course.
pub type r#ReturnsLastattemptUsergroups = Vec<Option<i64>>;
...
pub struct ReturnsLastattempt {
    ...
    pub r#submission: ReturnsLastattemptSubmission,
    /// submission info
    #[serde(rename = "teamsubmission")]
    pub r#teamsubmission: ReturnsLastattemptTeamsubmission,
    ...
    pub r#submissiongroupmemberswhoneedtosubmit:
        ReturnsLastattemptSubmissiongroupmemberswhoneedtosubmit,
    /// Whether submissions are enabled or not.
    #[serde(rename = "submissionsenabled")]
    pub r#submissionsenabled: Option<bool>,
    ...
    pub r#usergroups: ReturnsLastattemptUsergroups,
}
...
pub struct ReturnsFeedbackPluginsItemFileareasItem {
    ...
    /// files
    #[serde(rename = "files")]
    pub r#files: ReturnsFeedbackPluginsItemFileareasItemFiles,
}
...
pub struct ReturnsFeedbackPluginsItem {
    ...
    /// fileareas
    #[serde(rename = "fileareas")]
    pub r#fileareas: ReturnsFeedbackPluginsItemFileareas,
    /// editorfields
    #[serde(rename = "editorfields")]
    pub r#editorfields: ReturnsFeedbackPluginsItemEditorfields,
}
...
pub struct ReturnsFeedback {
    /// grade information
    #[serde(rename = "grade")]
    pub r#grade: ReturnsFeedbackGrade,
    /// Grade rendered into a format suitable for display.
    #[serde(rename = "gradefordisplay")]
    pub r#gradefordisplay: Option<String>,
    ...
    /// Plugins info.
    #[serde(rename = "plugins")]
    pub r#plugins: ReturnsFeedbackPlugins,
}
...
pub struct ReturnsPreviousattemptsItemSubmissionPluginsItemFileareasItem {
    ...
    /// files
    #[serde(rename = "files")]
    pub r#files: ReturnsPreviousattemptsItemSubmissionPluginsItemFileareasItemFiles,
}
...
pub struct ReturnsPreviousattemptsItemSubmissionPluginsItem {
    ...
    /// fileareas
    #[serde(rename = "fileareas")]
    pub r#fileareas: ReturnsPreviousattemptsItemSubmissionPluginsItemFileareas,
    /// editorfields
    #[serde(rename = "editorfields")]
    pub r#editorfields: ReturnsPreviousattemptsItemSubmissionPluginsItemEditorfields,
}
...
pub struct ReturnsPreviousattemptsItemSubmission {
    ...
    /// plugins
    #[serde(rename = "plugins")]
    pub r#plugins: ReturnsPreviousattemptsItemSubmissionPlugins,
    /// Grading status.
    #[serde(rename = "gradingstatus")]
    pub r#gradingstatus: Option<String>,
}
...
pub struct ReturnsPreviousattemptsItemFeedbackpluginsItemFileareasItem {
    ...
    /// files
    #[serde(rename = "files")]
    pub r#files: ReturnsPreviousattemptsItemFeedbackpluginsItemFileareasItemFiles,
}
...
pub struct ReturnsPreviousattemptsItemFeedbackpluginsItem {
    ...
    /// fileareas
    #[serde(rename = "fileareas")]
    pub r#fileareas: ReturnsPreviousattemptsItemFeedbackpluginsItemFileareas,
    /// editorfields
    #[serde(rename = "editorfields")]
    pub r#editorfields: ReturnsPreviousattemptsItemFeedbackpluginsItemEditorfields,
}
...
pub struct ReturnsPreviousattemptsItem {
    ...
    /// submission info
    #[serde(rename = "submission")]
    pub r#submission: ReturnsPreviousattemptsItemSubmission,
    /// grade information
    #[serde(rename = "grade")]
    pub r#grade: ReturnsPreviousattemptsItemGrade,
    /// Feedback info.
    #[serde(rename = "feedbackplugins")]
    pub r#feedbackplugins: ReturnsPreviousattemptsItemFeedbackplugins,
}
...
pub struct ReturnsAssignmentdataAttachments {
    /// Intro attachments files
    #[serde(rename = "intro")]
    pub r#intro: ReturnsAssignmentdataAttachmentsIntro,
    /// Activity attachments files
    #[serde(rename = "activity")]
    pub r#activity: ReturnsAssignmentdataAttachmentsActivity,
}
...
pub struct ReturnsAssignmentdata {
    ...
    pub r#attachments: ReturnsAssignmentdataAttachments,
    /// Text of activity
    #[serde(rename = "activity")]
...
pub struct Returns {
    ...
    pub r#gradingsummary: ReturnsGradingsummary,
    /// Last attempt information.
    #[serde(rename = "lastattempt")]
    pub r#lastattempt: ReturnsLastattempt,
    /// Feedback for the last attempt.
    #[serde(rename = "feedback")]
    pub r#feedback: ReturnsFeedback,
    /// List all the previous attempts did by the user.
    #[serde(rename = "previousattempts")]
    pub r#previousattempts: ReturnsPreviousattempts,
    /// Extra information about assignment
    #[serde(rename = "assignmentdata")]
    pub r#assignmentdata: ReturnsAssignmentdata,
    /// list of warnings
