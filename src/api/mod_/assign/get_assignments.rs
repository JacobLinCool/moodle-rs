...
pub type r#ParamsCapabilities = Vec<Option<String>>;
...
pub struct Params {
    ...
    pub r#capabilities: ParamsCapabilities,
...
pub struct ReturnsCoursesItemAssignmentsItem {
    ...
    pub r#configs: ReturnsCoursesItemAssignmentsItemConfigs,
    ...
    pub r#introfiles: ReturnsCoursesItemAssignmentsItemIntrofiles,
    /// intro attachments files
    #[serde(rename = "introattachments")]
    pub r#introattachments: ReturnsCoursesItemAssignmentsItemIntroattachments,
    ...
    pub r#activityattachments: ReturnsCoursesItemAssignmentsItemActivityattachments,
...
pub struct ReturnsCoursesItem {
    ...
    pub r#assignments: ReturnsCoursesItemAssignments,
}
