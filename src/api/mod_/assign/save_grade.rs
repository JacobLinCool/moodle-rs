...
pub struct ParamsPlugindata {
    ...
    pub r#assignfeedbackcomments_editor: ParamsPlugindataAssignfeedbackcommentsEditor,
...
pub struct ParamsAdvancedgradingdataGuideCriteriaItem {
    ...
    pub r#fillings: ParamsAdvancedgradingdataGuideCriteriaItemFillings,
}
...
pub struct ParamsAdvancedgradingdataGuide {
    ...
    pub r#criteria: ParamsAdvancedgradingdataGuideCriteria,
}
...
pub struct ParamsAdvancedgradingdataRubricCriteriaItem {
    ...
    /// filling
    #[serde(rename = "fillings")]
    pub r#fillings: ParamsAdvancedgradingdataRubricCriteriaItemFillings,
}
...
pub struct ParamsAdvancedgradingdataRubric {
    #[serde(rename = "criteria")]
    pub r#criteria: ParamsAdvancedgradingdataRubricCriteria,
}
...
pub struct ParamsAdvancedgradingdata {
    /// items
    #[serde(rename = "guide")]
    pub r#guide: ParamsAdvancedgradingdataGuide,
    /// items
    #[serde(rename = "rubric")]
    pub r#rubric: ParamsAdvancedgradingdataRubric,
}
...
pub struct Params {
    ...
    pub r#plugindata: ParamsPlugindata,
    /// advanced grading data
    #[serde(rename = "advancedgradingdata")]
    pub r#advancedgradingdata: ParamsAdvancedgradingdata,
}
