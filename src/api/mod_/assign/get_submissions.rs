...
pub type r#ParamsAssignmentids = Vec<Option<i64>>;

#[derive(Serialize, Deserialize, Debug)]
pub struct Params {
    /// 1 or more assignment ids
    #[serde(rename = "assignmentids")]
    pub r#assignmentids: ParamsAssignmentids,
    /// status
    #[serde(rename = "status")]
...
pub struct ReturnsAssignmentsItemSubmissionsItemPluginsItemFileareasItem {
    ...
    /// files
    #[serde(rename = "files")]
    pub r#files: ReturnsAssignmentsItemSubmissionsItemPluginsItemFileareasItemFiles,
}
...
pub struct ReturnsAssignmentsItemSubmissionsItemPluginsItem {
    ...
    pub r#fileareas: ReturnsAssignmentsItemSubmissionsItemPluginsItemFileareas,
    /// editorfields
    #[serde(rename = "editorfields")]
    pub r#editorfields: ReturnsAssignmentsItemSubmissionsItemPluginsItemEditorfields,
}
...
pub struct ReturnsAssignmentsItemSubmissionsItem {
    ...
    pub r#plugins: ReturnsAssignmentsItemSubmissionsItemPlugins,
    /// Grading status.
...
pub struct ReturnsAssignmentsItem {
    ...
    pub r#submissions: ReturnsAssignmentsItemSubmissions,
}
...
pub struct Returns {
    ...
    pub r#assignments: ReturnsAssignments,
    /// list of warnings
