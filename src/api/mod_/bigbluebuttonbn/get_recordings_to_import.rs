...
pub type r#ReturnsTabledataProfileFeatures = Vec<Option<String>>;
...
pub struct ReturnsTabledata {
    ...
    pub r#profile_features: ReturnsTabledataProfileFeatures,
    #[serde(rename = "columns")]
    pub r#columns: ReturnsTabledataColumns,
    #[serde(rename = "data")]
...
pub struct Returns {
    ...
    pub r#tabledata: ReturnsTabledata,
    /// list of warnings
