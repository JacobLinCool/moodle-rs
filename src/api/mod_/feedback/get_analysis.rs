...
pub struct ReturnsItemsdataItemItem {
    ...
    pub r#itemfiles: ReturnsItemsdataItemItemItemfiles,
...
pub type r#ReturnsItemsdataItemData = Vec<Option<String>>;

#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsItemsdataItem {
    #[serde(rename = "item")]
    pub r#item: ReturnsItemsdataItemItem,
    #[serde(rename = "data")]
    pub r#data: ReturnsItemsdataItemData,
}
...
pub struct Returns {
    ...
    pub r#itemsdata: ReturnsItemsdata,
    /// list of warnings
