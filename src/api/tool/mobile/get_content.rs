...
pub type r#ReturnsRestrictUsers = Vec<Option<i64>>;

/// List of allowed courses.
pub type r#ReturnsRestrictCourses = Vec<Option<i64>>;
...
pub struct ReturnsRestrict {
    /// List of allowed users.
    #[serde(rename = "users")]
    pub r#users: ReturnsRestrictUsers,
    /// List of allowed courses.
    #[serde(rename = "courses")]
    pub r#courses: ReturnsRestrictCourses,
}
...
pub struct Returns {
    ...
    pub r#templates: ReturnsTemplates,
    /// JavaScript code.
    #[serde(rename = "javascript")]
    pub r#javascript: Option<String>,
    /// Other data that can be used or manipulated by the template via 2-way data-binding.
    #[serde(rename = "otherdata")]
    pub r#otherdata: ReturnsOtherdata,
    /// Files in the content.
    #[serde(rename = "files")]
    pub r#files: ReturnsFiles,
    /// Restrict this content to certain users or courses.
    #[serde(rename = "restrict")]
    pub r#restrict: ReturnsRestrict,
