...
pub struct ReturnsCompetencyComppath {
    ...
    pub r#ancestors: ReturnsCompetencyComppathAncestors,
    #[serde(rename = "framework")]
    pub r#framework: ReturnsCompetencyComppathFramework,
    /// pluginbaseurl
...
pub struct ReturnsCompetency {
    ...
    pub r#linkedcourses: ReturnsCompetencyLinkedcourses,
    /// relatedcompetencies
    #[serde(rename = "relatedcompetencies")]
    pub r#relatedcompetencies: ReturnsCompetencyRelatedcompetencies,
    #[serde(rename = "competency")]
    pub r#competency: ReturnsCompetencyCompetency,
    #[serde(rename = "framework")]
    pub r#framework: ReturnsCompetencyFramework,
    /// hascourses
    ...
    pub r#comppath: ReturnsCompetencyComppath,
    /// pluginbaseurl
    #[serde(rename = "pluginbaseurl")]
    pub r#pluginbaseurl: Option<String>,
}
...
pub struct ReturnsUsercompetency {
    ...
    pub r#reviewer: ReturnsUsercompetencyReviewer,
    /// statusname
...
pub struct ReturnsEvidenceItem {
    ...
    pub r#actionuser: ReturnsEvidenceItemActionuser,
    /// description
    #[serde(rename = "description")]
    pub r#description: Option<String>,
    /// gradename
...
pub struct Returns {
    ...
    #[serde(rename = "competency")]
    pub r#competency: ReturnsCompetency,
    #[serde(rename = "user")]
    pub r#user: ReturnsUser,
    #[serde(rename = "usercompetency")]
    pub r#usercompetency: ReturnsUsercompetency,
    #[serde(rename = "usercompetencyplan")]
    pub r#usercompetencyplan: ReturnsUsercompetencyplan,
    #[serde(rename = "usercompetencycourse")]
    pub r#usercompetencycourse: ReturnsUsercompetencycourse,
    /// evidence
    #[serde(rename = "evidence")]
    pub r#evidence: ReturnsEvidence,
    #[serde(rename = "commentarea")]
    pub r#commentarea: ReturnsCommentarea,
}
