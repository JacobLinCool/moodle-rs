...
pub struct ReturnsUsercompetencysummaryCompetencyComppath {
    ...
    pub r#ancestors: ReturnsUsercompetencysummaryCompetencyComppathAncestors,
    #[serde(rename = "framework")]
    pub r#framework: ReturnsUsercompetencysummaryCompetencyComppathFramework,
    /// pluginbaseurl
...
pub struct ReturnsUsercompetencysummaryCompetency {
    ...
    pub r#linkedcourses: ReturnsUsercompetencysummaryCompetencyLinkedcourses,
    /// relatedcompetencies
    #[serde(rename = "relatedcompetencies")]
    pub r#relatedcompetencies: ReturnsUsercompetencysummaryCompetencyRelatedcompetencies,
    #[serde(rename = "competency")]
    pub r#competency: ReturnsUsercompetencysummaryCompetencyCompetency,
    #[serde(rename = "framework")]
    pub r#framework: ReturnsUsercompetencysummaryCompetencyFramework,
    /// hascourses
    ...
    pub r#comppath: ReturnsUsercompetencysummaryCompetencyComppath,
    /// pluginbaseurl
    #[serde(rename = "pluginbaseurl")]
    pub r#pluginbaseurl: Option<String>,
}
...
pub struct ReturnsUsercompetencysummaryUsercompetency {
    ...
    pub r#reviewer: ReturnsUsercompetencysummaryUsercompetencyReviewer,
    /// statusname
...
pub struct ReturnsUsercompetencysummaryEvidenceItem {
    ...
    pub r#actionuser: ReturnsUsercompetencysummaryEvidenceItemActionuser,
    /// description
    #[serde(rename = "description")]
    pub r#description: Option<String>,
    /// gradename
...
pub struct ReturnsUsercompetencysummary {
    ...
    #[serde(rename = "competency")]
    pub r#competency: ReturnsUsercompetencysummaryCompetency,
    #[serde(rename = "user")]
    pub r#user: ReturnsUsercompetencysummaryUser,
    #[serde(rename = "usercompetency")]
    pub r#usercompetency: ReturnsUsercompetencysummaryUsercompetency,
    #[serde(rename = "usercompetencyplan")]
    pub r#usercompetencyplan: ReturnsUsercompetencysummaryUsercompetencyplan,
    #[serde(rename = "usercompetencycourse")]
    pub r#usercompetencycourse: ReturnsUsercompetencysummaryUsercompetencycourse,
    /// evidence
    #[serde(rename = "evidence")]
    pub r#evidence: ReturnsUsercompetencysummaryEvidence,
    #[serde(rename = "commentarea")]
    pub r#commentarea: ReturnsUsercompetencysummaryCommentarea,
}
...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsCoursemodulesItem {
    /// id
    #[serde(rename = "id")]
    pub r#id: Option<i64>,
    /// name
...
/// coursemodules
pub type r#ReturnsCoursemodules = Vec<ReturnsCoursemodulesItem>;

#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsPlansItemCommentarea {
    /// component
    #[serde(rename = "component")]
    pub r#component: Option<String>,
    /// commentarea
...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsPlansItemReviewer {
    /// id
    #[serde(rename = "id")]
    pub r#id: Option<i64>,
    /// email
...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsPlansItemTemplate {
    /// shortname
    #[serde(rename = "shortname")]
    pub r#shortname: Option<String>,
    /// description
...
pub struct ReturnsPlansItem {
    ...
    pub r#duedateformatted: Option<String>,
    #[serde(rename = "commentarea")]
    pub r#commentarea: ReturnsPlansItemCommentarea,
    #[serde(rename = "reviewer")]
    pub r#reviewer: ReturnsPlansItemReviewer,
    #[serde(rename = "template")]
    pub r#template: ReturnsPlansItemTemplate,
    /// url
    #[serde(rename = "url")]
    pub r#url: Option<String>,
}
...
/// plans
pub type r#ReturnsPlans = Vec<ReturnsPlansItem>;

#[derive(Serialize, Deserialize, Debug)]
pub struct Returns {
    #[serde(rename = "usercompetencysummary")]
    pub r#usercompetencysummary: ReturnsUsercompetencysummary,
    #[serde(rename = "course")]
    pub r#course: ReturnsCourse,
    /// coursemodules
    #[serde(rename = "coursemodules")]
    pub r#coursemodules: ReturnsCoursemodules,
    /// plans
    #[serde(rename = "plans")]
    pub r#plans: ReturnsPlans,
    /// pluginbaseurl
    #[serde(rename = "pluginbaseurl")]
    pub r#pluginbaseurl: Option<String>,
}
...
pub async fn call<'a>(
    ...
    let json = client
        .post("tool_lp_data_for_user_competency_summary_in_course", params)
        .await?;
