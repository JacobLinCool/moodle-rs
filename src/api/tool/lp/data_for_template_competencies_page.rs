...
pub struct Params {
    ...
    pub r#pagecontext: ParamsPagecontext,
}
...
pub struct ReturnsCompetenciesItem {
    ...
    pub r#linkedcourses: ReturnsCompetenciesItemLinkedcourses,
    /// relatedcompetencies
    #[serde(rename = "relatedcompetencies")]
    pub r#relatedcompetencies: ReturnsCompetenciesItemRelatedcompetencies,
    #[serde(rename = "competency")]
    pub r#competency: ReturnsCompetenciesItemCompetency,
    #[serde(rename = "framework")]
    pub r#framework: ReturnsCompetenciesItemFramework,
    /// hascourses
...
pub struct Returns {
    ...
    pub r#template: ReturnsTemplate,
    /// Context ID
    #[serde(rename = "pagecontextid")]
    pub r#pagecontextid: Option<i64>,
