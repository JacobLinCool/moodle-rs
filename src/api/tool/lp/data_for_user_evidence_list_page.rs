...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsEvidenceItemFilesItem {
    /// contextid
...
/// files
pub type r#ReturnsEvidenceItemFiles = Vec<ReturnsEvidenceItemFilesItem>;

#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsEvidenceItemUsercompetenciesItemCompetency {
    /// shortname
...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsEvidenceItemUsercompetenciesItemUsercompetencyReviewer {
    /// id
    #[serde(rename = "id")]
    pub r#id: Option<i64>,
    /// email
...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsEvidenceItemUsercompetenciesItemUsercompetency {
    /// userid
    #[serde(rename = "userid")]
    pub r#userid: Option<i64>,
    /// competencyid
    ...
    pub r#reviewer: ReturnsEvidenceItemUsercompetenciesItemUsercompetencyReviewer,
    /// statusname
...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsEvidenceItemUsercompetenciesItem {
    #[serde(rename = "competency")]
    pub r#competency: ReturnsEvidenceItemUsercompetenciesItemCompetency,
    #[serde(rename = "usercompetency")]
    pub r#usercompetency: ReturnsEvidenceItemUsercompetenciesItemUsercompetency,
}

/// usercompetencies
pub type r#ReturnsEvidenceItemUsercompetencies = Vec<ReturnsEvidenceItemUsercompetenciesItem>;
...
pub struct ReturnsEvidenceItem {
    ...
    /// files
    #[serde(rename = "files")]
    pub r#files: ReturnsEvidenceItemFiles,
    /// hasurlorfiles
    ...
    pub r#usercompetencies: ReturnsEvidenceItemUsercompetencies,
    /// userhasplan
...
pub type r#ReturnsNavigation = Vec<Option<String>>;
...
pub struct Returns {
    ...
    pub r#evidence: ReturnsEvidence,
    #[serde(rename = "navigation")]
    pub r#navigation: ReturnsNavigation,
}
...
pub async fn call<'a>(
    ...
    let json = client
        .post("tool_lp_data_for_user_evidence_list_page", params)
        .await?;
