...
pub struct ReturnsStatistics {
    ...
    pub r#leastproficient: ReturnsStatisticsLeastproficient,
...
pub struct ReturnsCompetenciesItemComppath {
    ...
    pub r#ancestors: ReturnsCompetenciesItemComppathAncestors,
    #[serde(rename = "framework")]
    pub r#framework: ReturnsCompetenciesItemComppathFramework,
    /// pluginbaseurl
...
pub struct ReturnsCompetenciesItemPlansItem {
    ...
    pub r#duedateformatted: Option<String>,
    #[serde(rename = "commentarea")]
    pub r#commentarea: ReturnsCompetenciesItemPlansItemCommentarea,
    #[serde(rename = "reviewer")]
    pub r#reviewer: ReturnsCompetenciesItemPlansItemReviewer,
    #[serde(rename = "template")]
    pub r#template: ReturnsCompetenciesItemPlansItemTemplate,
    /// url
    #[serde(rename = "url")]
    pub r#url: Option<String>,
}
...
pub struct ReturnsCompetenciesItem {
    ...
    pub r#competency: ReturnsCompetenciesItemCompetency,
    #[serde(rename = "coursecompetency")]
    pub r#coursecompetency: ReturnsCompetenciesItemCoursecompetency,
    #[serde(rename = "coursemodules")]
    pub r#coursemodules: ReturnsCompetenciesItemCoursemodules,
    #[serde(rename = "usercompetencycourse")]
    pub r#usercompetencycourse: ReturnsCompetenciesItemUsercompetencycourse,
    #[serde(rename = "ruleoutcomeoptions")]
    pub r#ruleoutcomeoptions: ReturnsCompetenciesItemRuleoutcomeoptions,
    #[serde(rename = "comppath")]
    pub r#comppath: ReturnsCompetenciesItemComppath,
    #[serde(rename = "plans")]
    pub r#plans: ReturnsCompetenciesItemPlans,
}
...
pub struct Returns {
    ...
    pub r#settings: ReturnsSettings,
    #[serde(rename = "statistics")]
    pub r#statistics: ReturnsStatistics,
    #[serde(rename = "competencies")]
    pub r#competencies: ReturnsCompetencies,
