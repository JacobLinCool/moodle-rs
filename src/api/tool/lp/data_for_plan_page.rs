...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsCompetenciesItemUsercompetencyReviewer {
    /// id
    #[serde(rename = "id")]
    pub r#id: Option<i64>,
    /// email
...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsCompetenciesItemUsercompetency {
    /// userid
    #[serde(rename = "userid")]
    pub r#userid: Option<i64>,
    /// competencyid
    ...
    #[serde(rename = "reviewer")]
    pub r#reviewer: ReturnsCompetenciesItemUsercompetencyReviewer,
    /// statusname
    #[serde(rename = "statusname")]
    pub r#statusname: Option<String>,
    /// url
...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsCompetenciesItemUsercompetencyplan {
    /// userid
    #[serde(rename = "userid")]
    pub r#userid: Option<i64>,
    /// competencyid
...
pub struct ReturnsCompetenciesItem {
    ...
    pub r#usercompetency: ReturnsCompetenciesItemUsercompetency,
    #[serde(rename = "usercompetencyplan")]
    pub r#usercompetencyplan: ReturnsCompetenciesItemUsercompetencyplan,
}
...
pub async fn call<'a>(
    ...
    let json = client.post("tool_lp_data_for_plan_page", params).await?;
