...
pub struct ReturnsUserevidenceUsercompetenciesItemUsercompetency {
    ...
    pub r#reviewer: ReturnsUserevidenceUsercompetenciesItemUsercompetencyReviewer,
    /// statusname
...
pub struct ReturnsUserevidenceUsercompetenciesItem {
    ...
    pub r#competency: ReturnsUserevidenceUsercompetenciesItemCompetency,
    #[serde(rename = "usercompetency")]
    pub r#usercompetency: ReturnsUserevidenceUsercompetenciesItemUsercompetency,
}
...
pub struct ReturnsUserevidence {
    ...
    /// files
    #[serde(rename = "files")]
    pub r#files: ReturnsUserevidenceFiles,
    /// hasurlorfiles
    ...
    pub r#usercompetencies: ReturnsUserevidenceUsercompetencies,
    /// userhasplan
...
pub struct Returns {
    ...
    pub r#userevidence: ReturnsUserevidence,
