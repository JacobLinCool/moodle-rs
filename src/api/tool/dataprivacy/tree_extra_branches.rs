...
pub type r#ReturnsBranchesItemBranchesItemBranches = Vec<Option<String>>;
...
pub struct ReturnsBranchesItemBranchesItem {
    ...
    pub r#branches: ReturnsBranchesItemBranchesItemBranches,
}
...
pub struct ReturnsBranchesItem {
    ...
    /// Children node structure
    #[serde(rename = "branches")]
    pub r#branches: ReturnsBranchesItemBranches,
}
...
pub struct Returns {
    #[serde(rename = "branches")]
    pub r#branches: ReturnsBranches,
    /// list of warnings
