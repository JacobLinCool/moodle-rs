...
pub struct ReturnsPurpose {
    ...
    pub r#formattedlawfulbases: ReturnsPurposeFormattedlawfulbases,
    /// formattedsensitivedatareasons
    #[serde(rename = "formattedsensitivedatareasons")]
    pub r#formattedsensitivedatareasons: ReturnsPurposeFormattedsensitivedatareasons,
    /// roleoverrides
