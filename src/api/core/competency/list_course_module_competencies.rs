...
#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsItemCoursemodulecompetency {
    /// cmid
    #[serde(rename = "cmid")]
    pub r#cmid: Option<i64>,
    /// competencyid
    ...
    pub r#ruleoutcome: Option<i64>,
    /// overridegrade
    #[serde(rename = "overridegrade")]
    pub r#overridegrade: Option<bool>,
    /// id
    #[serde(rename = "id")]
    pub r#id: Option<i64>,
    /// timecreated
...
pub struct ReturnsItem {
    ...
    #[serde(rename = "coursemodulecompetency")]
    pub r#coursemodulecompetency: ReturnsItemCoursemodulecompetency,
}
...
pub async fn call<'a>(
    ...
    let json = client
        .post("core_competency_list_course_module_competencies", params)
        .await?;
