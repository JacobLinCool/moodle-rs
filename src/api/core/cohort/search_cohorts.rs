...
pub struct ReturnsCohortsItem {
    ...
    pub r#customfields: ReturnsCohortsItemCustomfields,
}
...
pub async fn call<'a>(
    ...
    let json = client.post("core_cohort_search_cohorts", params).await?;
