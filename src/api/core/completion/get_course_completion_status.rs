...
pub struct ReturnsCompletionstatusCompletionsItem {
    ...
    pub r#details: ReturnsCompletionstatusCompletionsItemDetails,
}
...
pub struct ReturnsCompletionstatus {
    ...
    pub r#completions: ReturnsCompletionstatusCompletions,
}
...
pub struct Returns {
    ...
    pub r#completionstatus: ReturnsCompletionstatus,
    /// list of warnings
