...
pub struct ReturnsBadgesItem {
    ...
    pub r#endorsement: ReturnsBadgesItemEndorsement,
    /// Badge alignments
    #[serde(rename = "alignment")]
    pub r#alignment: ReturnsBadgesItemAlignment,
    /// Related badges
    #[serde(rename = "relatedbadges")]
    pub r#relatedbadges: ReturnsBadgesItemRelatedbadges,
}
