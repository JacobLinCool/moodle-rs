...
pub type r#ParamsServiceshortnames = Vec<Option<String>>;
...
pub struct Params {
    ...
    pub r#serviceshortnames: ParamsServiceshortnames,
}
...
pub struct Returns {
    ...
    pub r#functions: ReturnsFunctions,
    ...
    pub r#advancedfeatures: ReturnsAdvancedfeatures,
