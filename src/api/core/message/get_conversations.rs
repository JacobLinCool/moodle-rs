...
pub struct ReturnsConversationsItemMembersItem {
    ...
    pub r#contactrequests: ReturnsConversationsItemMembersItemContactrequests,
    /// Conversations between users
    #[serde(rename = "conversations")]
    pub r#conversations: ReturnsConversationsItemMembersItemConversations,
}
...
pub struct ReturnsConversationsItem {
    ...
    pub r#members: ReturnsConversationsItemMembers,
    #[serde(rename = "messages")]
    pub r#messages: ReturnsConversationsItemMessages,
...
pub struct Returns {
    #[serde(rename = "conversations")]
    pub r#conversations: ReturnsConversations,
}
