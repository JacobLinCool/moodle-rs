...
pub struct ReturnsContactsItem {
    ...
    pub r#contactrequests: ReturnsContactsItemContactrequests,
    /// Conversations between users
    #[serde(rename = "conversations")]
    pub r#conversations: ReturnsContactsItemConversations,
}
...
pub struct ReturnsNoncontactsItem {
    ...
    /// The contact requests
    #[serde(rename = "contactrequests")]
    pub r#contactrequests: ReturnsNoncontactsItemContactrequests,
    /// Conversations between users
    #[serde(rename = "conversations")]
    pub r#conversations: ReturnsNoncontactsItemConversations,
}
...
pub struct Returns {
    ...
    pub r#contacts: ReturnsContacts,
    #[serde(rename = "noncontacts")]
    pub r#noncontacts: ReturnsNoncontacts,
}
