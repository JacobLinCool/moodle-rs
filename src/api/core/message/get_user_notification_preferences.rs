...
pub struct ReturnsPreferencesComponentsItemNotificationsItemProcessorsItem {
    ...
    pub r#loggedin: ReturnsPreferencesComponentsItemNotificationsItemProcessorsItemLoggedin,
    /// DEPRECATED ATTRIBUTE - Kept for backward compatibility, use enabled instead.
    #[serde(rename = "loggedoff")]
    pub r#loggedoff: ReturnsPreferencesComponentsItemNotificationsItemProcessorsItemLoggedoff,
    /// Is enabled?
...
pub struct ReturnsPreferencesComponentsItemNotificationsItem {
    ...
    pub r#processors: ReturnsPreferencesComponentsItemNotificationsItemProcessors,
}
...
pub struct ReturnsPreferencesComponentsItem {
    ...
    pub r#notifications: ReturnsPreferencesComponentsItemNotifications,
}
...
pub struct ReturnsPreferences {
    ...
    /// Config form values
    #[serde(rename = "processors")]
    pub r#processors: ReturnsPreferencesProcessors,
    /// Available components
    #[serde(rename = "components")]
    pub r#components: ReturnsPreferencesComponents,
}
...
pub struct Returns {
    ...
    pub r#preferences: ReturnsPreferences,
    /// list of warnings
...
pub async fn call<'a>(
    ...
    let json = client
        .post("core_message_get_user_notification_preferences", params)
        .await?;
