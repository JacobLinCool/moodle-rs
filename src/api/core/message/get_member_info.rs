...
pub struct Params {
    ...
    pub r#referenceuserid: Option<i64>,
...
pub struct ReturnsItem {
    ...
    pub r#contactrequests: ReturnsItemContactrequests,
    /// Conversations between users
    #[serde(rename = "conversations")]
    pub r#conversations: ReturnsItemConversations,
}
...
pub async fn call<'a>(
    ...
    let json = client.post("core_message_get_member_info", params).await?;
