...
/// List of event ids
pub type r#ParamsEventsEventids = Vec<Option<i64>>;

/// List of course ids for which events will be returned
pub type r#ParamsEventsCourseids = Vec<Option<i64>>;

/// List of group ids for which events should be returned
pub type r#ParamsEventsGroupids = Vec<Option<i64>>;

/// List of category ids for which events will be returned
pub type r#ParamsEventsCategoryids = Vec<Option<i64>>;
...
pub struct ParamsEvents {
    ...
    pub r#eventids: ParamsEventsEventids,
    /// List of course ids for which events will be returned
    #[serde(rename = "courseids")]
    pub r#courseids: ParamsEventsCourseids,
    /// List of group ids for which events should be returned
    #[serde(rename = "groupids")]
    pub r#groupids: ParamsEventsGroupids,
    /// List of category ids for which events will be returned
    #[serde(rename = "categoryids")]
    pub r#categoryids: ParamsEventsCategoryids,
}
