...
/// prepadding
pub type r#ReturnsWeeksItemPrepadding = Vec<Option<i64>>;

/// postpadding
pub type r#ReturnsWeeksItemPostpadding = Vec<Option<i64>>;
...
pub struct ReturnsWeeksItemDaysItemEventsItem {
    ...
    #[serde(rename = "icon")]
    pub r#icon: ReturnsWeeksItemDaysItemEventsItemIcon,
    #[serde(rename = "category")]
    pub r#category: ReturnsWeeksItemDaysItemEventsItemCategory,
    #[serde(rename = "course")]
    pub r#course: ReturnsWeeksItemDaysItemEventsItemCourse,
    #[serde(rename = "subscription")]
    pub r#subscription: ReturnsWeeksItemDaysItemEventsItemSubscription,
    /// canedit
    ...
    #[serde(rename = "action")]
    pub r#action: ReturnsWeeksItemDaysItemEventsItemAction,
    /// purpose
...
/// calendareventtypes
pub type r#ReturnsWeeksItemDaysItemCalendareventtypes = Vec<Option<String>>;
...
pub struct ReturnsWeeksItemDaysItem {
    ...
    /// events
    #[serde(rename = "events")]
    pub r#events: ReturnsWeeksItemDaysItemEvents,
    /// hasevents
    #[serde(rename = "hasevents")]
    pub r#hasevents: Option<bool>,
    /// calendareventtypes
    #[serde(rename = "calendareventtypes")]
    pub r#calendareventtypes: ReturnsWeeksItemDaysItemCalendareventtypes,
    /// previousperiod
...
pub struct ReturnsWeeksItem {
    ...
    pub r#prepadding: ReturnsWeeksItemPrepadding,
    /// postpadding
    #[serde(rename = "postpadding")]
    pub r#postpadding: ReturnsWeeksItemPostpadding,
    /// days
    #[serde(rename = "days")]
    pub r#days: ReturnsWeeksItemDays,
}
...
pub struct Returns {
    ...
    /// weeks
    #[serde(rename = "weeks")]
    pub r#weeks: ReturnsWeeks,
    /// daynames
    #[serde(rename = "daynames")]
    pub r#daynames: ReturnsDaynames,
    /// view
    #[serde(rename = "view")]
    pub r#view: Option<String>,
    #[serde(rename = "date")]
    pub r#date: ReturnsDate,
    /// periodname
    ...
    #[serde(rename = "previousperiod")]
    pub r#previousperiod: ReturnsPreviousperiod,
    /// previousperiodlink
    ...
    #[serde(rename = "nextperiod")]
    pub r#nextperiod: ReturnsNextperiod,
    /// nextperiodname
