...
pub struct ReturnsEventsItem {
    ...
    #[serde(rename = "icon")]
    pub r#icon: ReturnsEventsItemIcon,
    #[serde(rename = "category")]
    pub r#category: ReturnsEventsItemCategory,
    #[serde(rename = "course")]
    pub r#course: ReturnsEventsItemCourse,
    #[serde(rename = "subscription")]
    pub r#subscription: ReturnsEventsItemSubscription,
    /// canedit
    ...
    #[serde(rename = "action")]
    pub r#action: ReturnsEventsItemAction,
    /// purpose
...
pub async fn call<'a>(
    ...
    let json = client
        .post("core_calendar_get_calendar_upcoming_view", params)
        .await?;
