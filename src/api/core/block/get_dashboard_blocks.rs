...
pub struct ReturnsBlocksItemContents {
    ...
    /// Block files.
    #[serde(rename = "files")]
    pub r#files: ReturnsBlocksItemContentsFiles,
}
...
pub struct ReturnsBlocksItem {
    ...
    pub r#contents: ReturnsBlocksItemContents,
    /// Block instance and plugin configuration settings.
    #[serde(rename = "configs")]
    pub r#configs: ReturnsBlocksItemConfigs,
}
...
pub async fn call<'a>(
    ...
    let json = client
        .post("core_block_get_dashboard_blocks", params)
        .await?;
