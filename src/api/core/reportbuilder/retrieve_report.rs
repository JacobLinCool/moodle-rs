...
pub struct ReturnsDetails {
    ...
    pub r#modifiedby: ReturnsDetailsModifiedby,
}

/// headers
pub type r#ReturnsDataHeaders = Vec<Option<String>>;

/// columns
pub type r#ReturnsDataRowsItemColumns = Vec<Option<String>>;

#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsDataRowsItem {
    /// columns
    #[serde(rename = "columns")]
    pub r#columns: ReturnsDataRowsItemColumns,
}
...
pub struct ReturnsData {
    ...
    pub r#headers: ReturnsDataHeaders,
    /// rows
    #[serde(rename = "rows")]
    pub r#rows: ReturnsDataRows,
    /// totalrowcount
...
pub struct Returns {
    ...
    pub r#details: ReturnsDetails,
    #[serde(rename = "data")]
    pub r#data: ReturnsData,
    /// list of warnings
