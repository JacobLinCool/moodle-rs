...
pub struct Params {
    ...
    pub r#uniqueidentifier: Option<String>,
}
...
pub struct ReturnsAvailablefiltersItemOptiongroup {
    ...
    /// values
    #[serde(rename = "values")]
    pub r#values: ReturnsAvailablefiltersItemOptiongroupValues,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsAvailablefiltersItem {
    #[serde(rename = "optiongroup")]
    pub r#optiongroup: ReturnsAvailablefiltersItemOptiongroup,
}
...
pub async fn call<'a>(
    ...
    let json = client
        .post("core_reportbuilder_filters_add", params)
        .await?;
