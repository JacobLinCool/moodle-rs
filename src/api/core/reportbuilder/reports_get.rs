...
pub struct ReturnsSidebarmenucardsMenucardsItem {
    ...
    /// items
    #[serde(rename = "items")]
    pub r#items: ReturnsSidebarmenucardsMenucardsItemItems,
}
...
pub struct ReturnsSidebarmenucards {
    ...
    pub r#menucards: ReturnsSidebarmenucardsMenucards,
}
...
pub struct ReturnsConditionsAvailableconditionsItemOptiongroup {
    ...
    /// values
    #[serde(rename = "values")]
    pub r#values: ReturnsConditionsAvailableconditionsItemOptiongroupValues,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsConditionsAvailableconditionsItem {
    #[serde(rename = "optiongroup")]
    pub r#optiongroup: ReturnsConditionsAvailableconditionsItemOptiongroup,
}
...
pub struct ReturnsConditions {
    ...
    pub r#availableconditions: ReturnsConditionsAvailableconditions,
    /// hasactiveconditions
...
pub struct ReturnsFiltersAvailablefiltersItemOptiongroup {
    ...
    /// values
    #[serde(rename = "values")]
    pub r#values: ReturnsFiltersAvailablefiltersItemOptiongroupValues,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsFiltersAvailablefiltersItem {
    #[serde(rename = "optiongroup")]
    pub r#optiongroup: ReturnsFiltersAvailablefiltersItemOptiongroup,
}
...
pub struct ReturnsFilters {
    ...
    pub r#availablefilters: ReturnsFiltersAvailablefilters,
    /// hasactivefilters
    #[serde(rename = "hasactivefilters")]
    pub r#hasactivefilters: Option<bool>,
    /// activefilters
    #[serde(rename = "activefilters")]
    pub r#activefilters: ReturnsFiltersActivefilters,
    /// helpicon
    #[serde(rename = "helpicon")]
    pub r#helpicon: Option<String>,
}
...
pub struct ReturnsSortingSortablecolumnsItem {
    ...
    pub r#sorticon: ReturnsSortingSortablecolumnsItemSorticon,
    /// movetitle
    #[serde(rename = "movetitle")]
    pub r#movetitle: Option<String>,
    /// sortenabledtitle
...
pub struct ReturnsSorting {
    ...
    pub r#sortablecolumns: ReturnsSortingSortablecolumns,
    /// helpicon
    #[serde(rename = "helpicon")]
    pub r#helpicon: Option<String>,
}
...
pub struct Returns {
    ...
    pub r#attributes: ReturnsAttributes,
    /// classes
    ...
    pub r#sidebarmenucards: ReturnsSidebarmenucards,
    #[serde(rename = "conditions")]
    pub r#conditions: ReturnsConditions,
    #[serde(rename = "filters")]
    pub r#filters: ReturnsFilters,
    #[serde(rename = "sorting")]
    pub r#sorting: ReturnsSorting,
    #[serde(rename = "cardview")]
    pub r#cardview: ReturnsCardview,
    /// javascript
    #[serde(rename = "javascript")]
    pub r#javascript: Option<String>,
}
