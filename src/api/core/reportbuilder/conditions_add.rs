...
pub struct ReturnsAvailableconditionsItemOptiongroup {
    ...
    /// values
    #[serde(rename = "values")]
    pub r#values: ReturnsAvailableconditionsItemOptiongroupValues,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct ReturnsAvailableconditionsItem {
    #[serde(rename = "optiongroup")]
    pub r#optiongroup: ReturnsAvailableconditionsItemOptiongroup,
}
...
pub struct Returns {
    ...
    pub r#availableconditions: ReturnsAvailableconditions,
    /// hasactiveconditions
...
pub async fn call<'a>(
    ...
    let json = client
        .post("core_reportbuilder_conditions_add", params)
        .await?;
