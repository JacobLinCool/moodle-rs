...
pub struct ReturnsAreasItemDefinitionsItemGuide {
    ...
    pub r#guide_criteria: ReturnsAreasItemDefinitionsItemGuideGuideCriteria,
    /// comments
    #[serde(rename = "guide_comments")]
    pub r#guide_comments: ReturnsAreasItemDefinitionsItemGuideGuideComments,
}
...
pub struct ReturnsAreasItemDefinitionsItemRubricRubricCriteriaItem {
    ...
    /// levels
    #[serde(rename = "levels")]
    pub r#levels: ReturnsAreasItemDefinitionsItemRubricRubricCriteriaItemLevels,
}
...
pub struct ReturnsAreasItemDefinitionsItemRubric {
    ...
    pub r#rubric_criteria: ReturnsAreasItemDefinitionsItemRubricRubricCriteria,
}
...
pub struct ReturnsAreasItemDefinitionsItem {
    ...
    /// items
    #[serde(rename = "guide")]
    pub r#guide: ReturnsAreasItemDefinitionsItemGuide,
    /// items
    #[serde(rename = "rubric")]
    pub r#rubric: ReturnsAreasItemDefinitionsItemRubric,
}
...
pub struct ReturnsAreasItem {
    ...
    pub r#definitions: ReturnsAreasItemDefinitions,
}
