...
pub struct ParamsAreasItemDefinitionsItemGuide {
    ...
    pub r#guide_criteria: ParamsAreasItemDefinitionsItemGuideGuideCriteria,
    /// comments
    #[serde(rename = "guide_comments")]
    pub r#guide_comments: ParamsAreasItemDefinitionsItemGuideGuideComments,
}
...
pub struct ParamsAreasItemDefinitionsItemRubricRubricCriteriaItem {
    ...
    /// levels
    #[serde(rename = "levels")]
    pub r#levels: ParamsAreasItemDefinitionsItemRubricRubricCriteriaItemLevels,
}
...
pub struct ParamsAreasItemDefinitionsItemRubric {
    ...
    pub r#rubric_criteria: ParamsAreasItemDefinitionsItemRubricRubricCriteria,
}
...
pub struct ParamsAreasItemDefinitionsItem {
    ...
    /// items
    #[serde(rename = "guide")]
    pub r#guide: ParamsAreasItemDefinitionsItemGuide,
    /// items
    #[serde(rename = "rubric")]
    pub r#rubric: ParamsAreasItemDefinitionsItemRubric,
}
...
pub struct ParamsAreasItem {
    ...
    pub r#definitions: ParamsAreasItemDefinitions,
}
