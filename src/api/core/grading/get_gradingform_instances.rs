...
pub struct ReturnsInstancesItemGuide {
    ...
    pub r#criteria: ReturnsInstancesItemGuideCriteria,
}
...
pub struct ReturnsInstancesItemRubric {
    /// filling
    #[serde(rename = "criteria")]
    pub r#criteria: ReturnsInstancesItemRubricCriteria,
}
...
pub struct ReturnsInstancesItem {
    ...
    /// items
    #[serde(rename = "guide")]
    pub r#guide: ReturnsInstancesItemGuide,
    /// items
    #[serde(rename = "rubric")]
    pub r#rubric: ReturnsInstancesItemRubric,
}
