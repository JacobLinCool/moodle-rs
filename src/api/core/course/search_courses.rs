...
pub type r#ParamsRequiredcapabilities = Vec<Option<String>>;
...
pub struct Params {
    ...
    pub r#requiredcapabilities: ParamsRequiredcapabilities,
...
pub type r#ReturnsCoursesItemEnrollmentmethods = Vec<Option<String>>;
...
pub struct ReturnsCoursesItem {
    ...
    pub r#summaryfiles: ReturnsCoursesItemSummaryfiles,
    /// additional overview files attached to this course
    #[serde(rename = "overviewfiles")]
    pub r#overviewfiles: ReturnsCoursesItemOverviewfiles,
    ...
    pub r#contacts: ReturnsCoursesItemContacts,
    /// enrollment methods list
    #[serde(rename = "enrollmentmethods")]
    pub r#enrollmentmethods: ReturnsCoursesItemEnrollmentmethods,
    /// Custom fields
    #[serde(rename = "customfields")]
    pub r#customfields: ReturnsCoursesItemCustomfields,
}
