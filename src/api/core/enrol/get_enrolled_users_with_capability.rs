...
pub type r#ParamsCoursecapabilitiesItemCapabilities = Vec<Option<String>>;
...
pub struct ParamsCoursecapabilitiesItem {
    ...
    pub r#capabilities: ParamsCoursecapabilitiesItemCapabilities,
}
...
pub struct Params {
    ...
    pub r#coursecapabilities: ParamsCoursecapabilities,
...
pub struct ReturnsItemUsersItem {
    ...
    pub r#customfields: ReturnsItemUsersItemCustomfields,
    /// user groups
    #[serde(rename = "groups")]
    pub r#groups: ReturnsItemUsersItemGroups,
    /// user roles
    #[serde(rename = "roles")]
    pub r#roles: ReturnsItemUsersItemRoles,
    /// User preferences
    #[serde(rename = "preferences")]
    pub r#preferences: ReturnsItemUsersItemPreferences,
    /// Courses where the user is enrolled - limited by which courses the user is able to see
    #[serde(rename = "enrolledcourses")]
    pub r#enrolledcourses: ReturnsItemUsersItemEnrolledcourses,
}
