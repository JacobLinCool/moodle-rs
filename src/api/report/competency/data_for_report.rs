...
pub struct ReturnsUsercompetenciesItemCompetencyComppath {
    ...
    pub r#ancestors: ReturnsUsercompetenciesItemCompetencyComppathAncestors,
    #[serde(rename = "framework")]
    pub r#framework: ReturnsUsercompetenciesItemCompetencyComppathFramework,
    /// pluginbaseurl
...
pub struct ReturnsUsercompetenciesItemCompetency {
    ...
    pub r#linkedcourses: ReturnsUsercompetenciesItemCompetencyLinkedcourses,
    /// relatedcompetencies
    #[serde(rename = "relatedcompetencies")]
    pub r#relatedcompetencies: ReturnsUsercompetenciesItemCompetencyRelatedcompetencies,
    #[serde(rename = "competency")]
    pub r#competency: ReturnsUsercompetenciesItemCompetencyCompetency,
    #[serde(rename = "framework")]
    pub r#framework: ReturnsUsercompetenciesItemCompetencyFramework,
    /// hascourses
    ...
    pub r#comppath: ReturnsUsercompetenciesItemCompetencyComppath,
    /// pluginbaseurl
    #[serde(rename = "pluginbaseurl")]
    pub r#pluginbaseurl: Option<String>,
}
...
pub struct ReturnsUsercompetenciesItem {
    ...
    pub r#usercompetencycourse: ReturnsUsercompetenciesItemUsercompetencycourse,
    #[serde(rename = "competency")]
    pub r#competency: ReturnsUsercompetenciesItemCompetency,
}
...
pub struct Returns {
    ...
    pub r#courseid: Option<i64>,
    #[serde(rename = "user")]
    pub r#user: ReturnsUser,
    #[serde(rename = "course")]
    pub r#course: ReturnsCourse,
    #[serde(rename = "usercompetencies")]
    pub r#usercompetencies: ReturnsUsercompetencies,
