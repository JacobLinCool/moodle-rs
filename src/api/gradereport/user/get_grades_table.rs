...
pub type r#ReturnsTablesItemTabledataItemParentcategories = Vec<Option<i64>>;
...
pub struct ReturnsTablesItemTabledataItem {
    ...
    pub r#itemname: ReturnsTablesItemTabledataItemItemname,
    /// The item returned data
    #[serde(rename = "leader")]
    pub r#leader: ReturnsTablesItemTabledataItemLeader,
    /// weight column
    #[serde(rename = "weight")]
    pub r#weight: ReturnsTablesItemTabledataItemWeight,
    /// grade column
    #[serde(rename = "grade")]
    pub r#grade: ReturnsTablesItemTabledataItemGrade,
    /// range column
    #[serde(rename = "range")]
    pub r#range: ReturnsTablesItemTabledataItemRange,
    /// percentage column
    #[serde(rename = "percentage")]
    pub r#percentage: ReturnsTablesItemTabledataItemPercentage,
    /// lettergrade column
    #[serde(rename = "lettergrade")]
    pub r#lettergrade: ReturnsTablesItemTabledataItemLettergrade,
    /// rank column
    #[serde(rename = "rank")]
    pub r#rank: ReturnsTablesItemTabledataItemRank,
    /// average column
    #[serde(rename = "average")]
    pub r#average: ReturnsTablesItemTabledataItemAverage,
    /// feedback column
    #[serde(rename = "feedback")]
    pub r#feedback: ReturnsTablesItemTabledataItemFeedback,
    /// contributiontocoursetotal column
    #[serde(rename = "contributiontocoursetotal")]
    pub r#contributiontocoursetotal: ReturnsTablesItemTabledataItemContributiontocoursetotal,
    #[serde(rename = "parentcategories")]
    pub r#parentcategories: ReturnsTablesItemTabledataItemParentcategories,
}
...
pub struct ReturnsTablesItem {
    ...
    pub r#tabledata: ReturnsTablesItemTabledata,
}
