...
pub struct ReturnsUsersItem {
    ...
    pub r#customfields: ReturnsUsersItemCustomfields,
    /// Users preferences
    #[serde(rename = "preferences")]
    pub r#preferences: ReturnsUsersItemPreferences,
}
...
pub async fn call<'a>(
    ...
    let json = client
        .post("gradereport_grader_get_users_in_report", params)
        .await?;
