...
pub struct ReturnsGradeCriteriaItem {
    ...
    #[serde(rename = "levels")]
    pub r#levels: ReturnsGradeCriteriaItemLevels,
}
...
pub struct ReturnsGrade {
    ...
    pub r#criteria: ReturnsGradeCriteria,
...
pub async fn call<'a>(
    ...
    let json = client
        .post("gradingform_rubric_grader_gradingpanel_store", params)
        .await?;
